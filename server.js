...
app.get('/api/diagnostics',(req,res)=>res.json({ok:true,data:{adminConfigured:Boolean(process.env.ADMIN_EMAIL&&process.env.ADMIN_PASSWORD),fixedOtpEnabled:process.env.DEV_FIXED_OTP==='true',devOtpLogEnabled:process.env.DEV_OTP_LOG==='true',nodeEnv:process.env.NODE_ENV||'development'}}));
